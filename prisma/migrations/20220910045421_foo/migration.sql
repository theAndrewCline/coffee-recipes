/*
  ...
  - You are about to drop the column `recipe_id` on the `RecipeStep` table. All the data in the column will be lost.
  ...
  - Added the required column `recipeId` to the `RecipeStep` table without a default value. This is not possible if the table is not empty.
